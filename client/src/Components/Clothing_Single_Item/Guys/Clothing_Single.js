...
class Single_Shirt extends Component {
        ...
        {this.state.active.length !== 0 &&
          <div className="Single_Container">
            ...
            <div className="Single_Content">
              ...
              <hr style={{ height: "2px", backgroundColor: "#42a5f5", border: "none" }} />
              ...
              <h6><Link to="/guys/shirts">Continue Shopping</Link></h6>
            </div>
          </div>
        }
      </div>
