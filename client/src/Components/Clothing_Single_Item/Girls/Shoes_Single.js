...
class Shoes_Single extends Component {
  state = { active_shoe: [], activeState: ["Add To Cart"] }

  componentDidMount() {
    const shoes_id = this.props.location.state.shoe;
    axios.get(`/api/girls/shoes/${shoes_id}`)
      ...
      <div className="Single_Object NoOverflow">
        ...
        {this.state.active_shoe.length !== 0 &&
          <div className="Single_Container">
            <img src={this.state.active_shoe.data.src} alt="" style={{
            ...
            <div className="Single_Content">
              ...
              <h6><Link to="/girls/shoes">Continue Shopping</Link></h6>
            </div>
          </div>
        }
      </div>
