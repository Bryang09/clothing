...
class Bottom_Single extends Component {
  ...
  componentDidMount() {
    const bottom_id = this.props.location.state.bottom;
    axios.get(`/api/girls/bottoms/${bottom_id}`)
      .then(bottom => this.setState({ active_pant: bottom }))
  }
  render() {
    return (
      <div className="Single_Object NoOverflow">
        ...
        {this.state.active_pant.length !== 0 &&
          <div className="Single_Container">
            <img src={this.state.active_pant.data.src} alt="" style={{
            ...
            <div className="Single_Content">
              ...
              <h6><Link to="/girls/bottoms">Continue Shopping</Link></h6>
            </div>
          </div>
        }
      </div>
